...
// Main functions ==============================
fn generate_random_string(use_digits: bool, use_lowercase: bool, use_uppercase: bool, use_spec: bool, length: usize) -> String {
    RandomStringGenerator::new(use_digits, use_lowercase, use_uppercase, use_spec).generate(length)
}


fn generate_random_choose<T>(items: Vec<T>, count_of_items: usize) -> Vec<T>
where
